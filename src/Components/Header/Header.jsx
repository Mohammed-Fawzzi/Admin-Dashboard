        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start rtl:justify-end">
            ...
            <a href="#" className="flex ms-2 md:me-24">
              <MdSpaceDashboard className="h-8 me-3 text-violet-500 text-2xl" />
              <span className="self-center text-xl font-semibold sm:text2xl whitespace-nowrap dark:text-white">
                AdminPanelX
              </span>
            </a>
          </div>
